...
class Index(models.Model):
	courses		= models.CharField(max_length=1024)#主要课程
	...
	liv_min		= models.ImageField(upload_to = 'photo',blank=True,null=True)#直播页小图片
	liv_max		= models.ImageField(upload_to = 'photo',blank=True,null=True)#直播页小图片
	stu_min		= models.ImageField(upload_to = 'photo',blank=True,null=True)#学生作品页小图片
	stu_max		= models.ImageField(upload_to = 'photo',blank=True,null=True)#学生作品页大图片
	cou_min		= models.ImageField(upload_to = 'photo',blank=True,null=True)#所有课程页小图片
	cou_min		= models.ImageField(upload_to = 'photo',blank=True,null=True)#所有课程页小图片
	def photo_tag(self):
...
class Live(models.Model):
	...
	mov_remarks	= models.TextField(null=True)#直播作品备注
